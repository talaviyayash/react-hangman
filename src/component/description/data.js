...
export const HOW_MANY_GUESSES = "Incorrect guesses:";

export const HINT = "Hint:-";

export const HANGMAN_GAME = "HANGMAN GAME";

export const RESTART = "Restart";

export const PLAY_AGAIN = "PLAY AGAIN";

export const THE_CORRECT_WORD_WAS = "The correct word was :-";

export const YOU_FOUND_WORD = "You found correct word :- ";
